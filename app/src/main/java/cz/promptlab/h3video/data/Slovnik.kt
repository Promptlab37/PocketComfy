...
object Slovnik {
    ...
    val EN: Map<String, String> = mapOf(
        ...
        "Načítám %s" to "Loading %s",
        "Přidávám plátno" to "Adding canvas",
        "Rozšiřuji obrázek" to "Extending the image",
        "Napojuji rozšíření na fotku" to "Blending the extension into the photo",
        "Rozšíření obrázku" to "Image extension",
        "Načítám model úpravy" to "Loading the edit model",
        "Model úpravy + textový enkodér" to "Edit model + text encoder",
        "Načítám model obrázku" to "Loading the image model",
        "Model obrázku + textový enkodér" to "Image model + text encoder",
        "Video model + textový enkodér" to "Video model + text encoder",
        "Načítám Qwen Image" to "Loading Qwen Image",
        "Qwen Image — nový úhel kamery" to "Qwen Image — new camera angle",
        "LoRA Detailer" to "LoRA Detailer",
