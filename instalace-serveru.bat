...
if /i "!ODP!"=="a" (
  ...
  call :stahni "https://huggingface.co/Comfy-Org/Qwen-Image-2.1/resolve/main/vae/qwen_image_2.1_vae_bf16.safetensors" "models\vae\qwen_image_2.1_vae_bf16.safetensors"
  echo   Pozn.: vyzaduje ComfyUI 0.37.0 nebo novejsi. Zadny custom node k tomu neni potreba.
)

REM  Vlastni prepisovace zadani od Qwenu. Nepovinne - karty jedou i bez nich,
REM  jen si zadani musis napsat sam.
set /p ODP="Vylepsovace zadani k Qwen Image 2.1 - nepovinne, cca 19 GB. Stahnout? [a/n] "
if /i "!ODP!"=="a" (
  call :stahni "https://huggingface.co/Comfy-Org/Qwen-Image-2.1/resolve/main/text_encoders/qwen3.5_9b_qwen_image_2.1_pe_i2i.int8_convrot.safetensors" "models\text_encoders\qwen3.5_9b_qwen_image_2.1_pe_i2i.int8_convrot.safetensors"
  call :stahni "https://huggingface.co/Comfy-Org/Qwen-Image-2.1/resolve/main/text_encoders/qwen3.5_9b_qwen_image_2.1_pe_t2i.int8_convrot.safetensors" "models\text_encoders\qwen3.5_9b_qwen_image_2.1_pe_t2i.int8_convrot.safetensors"
  echo   Pozn.: PE-I2I je pro upravy, PE-T2I pro generovani. Oba zadani potichu zjemni;
  echo         odvazany prepisovac je nize u vylepsovace promptu.
)
...
if /i "!ODP!"=="a" (
  ...
  echo   Pozn.: bez LoRA multiple-angles se pohled nezmeni - model fotku jen lehce prekresli.
)
